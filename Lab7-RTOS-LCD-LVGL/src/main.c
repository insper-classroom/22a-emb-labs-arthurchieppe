...
void lv_termostato(void) {
    ...
    lv_obj_align(btnPower, LV_ALIGN_BOTTOM_LEFT, 20, 0);
    ...
    // lv_obj_align(btnDown, LV_ALIGN_BOTTOM_LEFT, 20, -40);
	// lv_obj_add_style(btnDown, &style, 0);
	// labelBtnDown = lv_label_create(btnDown);
	// lv_label_set_text(labelBtnDown, "[  " LV_SYMBOL_POWER);
